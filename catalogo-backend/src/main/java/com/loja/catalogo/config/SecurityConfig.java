    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/products/**").permitAll() // GET de produtos é público
                .requestMatchers(HttpMethod.POST, "/products/**").hasAuthority("ADMIN") // Criar produto requer ADMIN
                .requestMatchers(HttpMethod.PUT, "/products/**").hasAuthority("ADMIN") // Editar produto requer ADMIN
                .requestMatchers(HttpMethod.DELETE, "/products/**").hasAuthority("ADMIN") // Deletar produto requer ADMIN
